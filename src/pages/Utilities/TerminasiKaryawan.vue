              ...
              <v-card-text class="fontall">
                <v-form ref="form" v-model="valid" lazy-validation>
                  <v-container fluid>
                    ...
                    <v-row class="mb-1 mt-0">
                      <h4 style="color: black; font-size: 18px">Terminasi Karyawan</h4>
                      <v-divider
                        class="mx-2 mt-3"
                        style="border-color: black"
                      ></v-divider>
                    ...
                    <v-row> 
                      ...
                      <v-col cols="12" sm="12" md="12">
                        <v-textarea
                          ...
                          v-model="defaultItem.alasan_terminasi"
                          :disabled='isDisableDetail'
                          :filled='isDisableDetail'
                        ></v-textarea>
                      </v-col> 
...
export default {
  ...
  methods: {
    ...
    async initialize() {
      try {
        const response = await axios.get(
          this.BaseUrlGet + "GetPAKontrakKaryawan?flag_menu=Terminasi_Karyawan",
          {
            headers: {
              Authorization: `Bearer ` + this.authtoken,
            },
    ...
    async save() {
      ...
      this.defaultItem.flag_menu = 'Terminasi_Karyawan'
    ...
    resetItem() {
      ...
      this.defaultItem.alasan_terminasi = "";
