...
export default {
  ...
  methods: {
    ...
    async initialize() {
      try {
        const response = await axios.get(
          this.BaseUrlGet + "GetPAJabatanKaryawan?flag_menu=Promosi_Karyawan",
          {
            headers: {
              Authorization: `Bearer ` + this.authtoken,
            },
    ...
    async save() {
      ...
      this.defaultItem.flag_menu = 'Promosi_Karyawan'
