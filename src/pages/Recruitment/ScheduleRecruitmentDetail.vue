  ...
  <div>
    ...
    <v-card class="pr-2 mx-2">
      <v-row class="mb-0 mt-0 ml-1 pl-1 pt-2 pb-0">
          <h3>Detail Proses Rekruitmen</h3>
      ...
      <v-card>
        ...
        <v-card-text class="fontall">
          <v-container fluid>
            ...
            <v-row class="mb-3 mt-2 ml-1" style="border-style: solid;padding: 5px;text-align: center;">
                      <v-col cols="12" sm="12" md="12" class="pa-1">
                        <h4>Status akan Terpenuhi/Selesai. Rekruitmen akan berpindah ke Menu 'Hasil Seleksi' dan tidak bisa kembali ke menu awal. </h4> <br>
                      </v-col>
            </v-row>
          </v-container>
        </v-card-text>
...
export default {
  ...
  methods: {
    ...
    backButton(){
      this.$router.push("/ScheduleRecruitment");
    },
